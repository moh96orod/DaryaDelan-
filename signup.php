            ...
            <div class="content2" style="">
                <div class="login">
                    ...
                    <form action="./signup/signup.php" method="POST">
                        ...
                        <br />
                        <br />
                        <input type="number" class="searchInput" placeholder="شماره تلفن" name="phone">
                        <br />
                        <br />
                        <input type="text" class="searchInput" placeholder="آدرس محل سکونت" name="location">
                        <br />
                        <br />
                    ...
                    <button class="btn btn-secondary"><a style="color: white;" href="./login.php">ورود به حساب کاربری</a></button>
                </div>
            </div>
        </div>
    </div>
